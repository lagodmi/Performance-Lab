...
class TestTask1(TestCase):
    def test_getIndex(self):
        self.assertEqual(0, getIndex(1, 0, 5))

        self.assertEqual(0, getIndex(2, 0, 5))

        self.assertEqual(1, getIndex(3, 0, 5))
        self.assertEqual(2, getIndex(3, 1, 5))
        self.assertEqual(0, getIndex(3, 2, 5))
        ...
        self.assertEqual(4, getIndex(5, 1, 4))
        self.assertEqual(2, getIndex(5, 4, 4))
